    ...
    <div className="relative pt-32 pb-24 min-h-screen overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <span className="text-xs font-bold tracking-widest uppercase mb-4 block" style={{ color: '#00FF87' }}>Conectemos</span>
          <h1 className="text-5xl md:text-7xl font-black mb-6" style={{ letterSpacing: '-.03em' }}>
            Hablemos del <br />
            <span style={{ color: '#00FF87' }}>Futuro.</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
           ...
           <div className="space-y-8">
              <div className="p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-[#00FF87] transition-all group">
              ...
              <div className="space-y-6">
                 ...
                 <div className="space-y-2">
                    ...
                    <textarea rows={4} placeholder="¿En qué podemos ayudarte?" 
                           className="w-full bg-white/5 border border-white/10 rounded-xl p-4 text-sm focus:border-[#00FF87] outline-none transition-all resize-none" />
                 </div>
